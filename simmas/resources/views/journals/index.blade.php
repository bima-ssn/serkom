                    ...
                    <form method="GET" action="{{ route('journals.index') }}" class="space-y-4">
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 items-end">
                            ...
                            <div class="lg:col-span-2 flex items-end space-x-3">
                                <a href="{{ route('journals.index') }}" class="flex-1 px-4 py-2.5 border border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-gray-50 font-medium transition-colors text-center">
                                    Reset Filter
                                </a>
                                <div class="flex-1">
