...
@endphp
<aside x-data="{ collapsed: JSON.parse(localStorage.getItem('sidebarCollapsed') || 'false') }" x-init="$watch('collapsed', v => localStorage.setItem('sidebarCollapsed', JSON.stringify(v)))" :class="collapsed ? 'w-20' : 'w-64'" class="hidden sm:flex sm:flex-col bg-white shadow-lg">
    <!-- SIMMAS Header -->
    <div class="px-6 py-8">
        <div class="flex items-center gap-3">
            ...
            <button @click="collapsed = !collapsed" :aria-label="collapsed ? 'Perluas sidebar' : 'Ciutkan sidebar'" class="ml-auto p-2 rounded-md text-gray-500 hover:bg-gray-100">
    ...
    <nav class="flex-1 px-4">
        ...
        <ul class="space-y-2">
            <li>
                <a href="{{ route('dashboard') }}" title="Dashboard" class="group flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium {{ request()->routeIs('dashboard') ? 'bg-teal-600 text-white' : 'text-gray-700 hover:bg-gray-50' }}">
                    ...
                    <div x-show="!collapsed" class="flex-1">
            ...
            <li>
                <a href="{{ route('dudis.index') }}" title="DUDI" class="group flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium {{ request()->routeIs('dudis.*') ? 'bg-teal-600 text-white' : 'text-gray-700 hover:bg-gray-50' }}">
            ...
            <li>
                <a href="{{ route('internships.index') }}" title="Magang" class="group flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium {{ request()->routeIs('internships.*') ? 'bg-teal-600 text-white' : 'text-gray-700 hover:bg-gray-50' }}">
            ...
            @if($role === 'guru')
            <li>
                <a href="{{ route('journals.index') }}" title="Jurnal Harian" class="group flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium {{ request()->routeIs('journals.*') ? 'bg-teal-600 text-white' : 'text-gray-700 hover:bg-gray-50' }}">
            ...
            @if($role === 'admin')
            <li>
                <a href="{{ route('users.index') }}" title="Pengguna" class="group flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium {{ request()->routeIs('users.*') ? 'bg-teal-600 text-white' : 'text-gray-700 hover:bg-gray-50' }}">
            ...
            <li>
                <a href="{{ route('school-settings.index') }}" title="Pengaturan" class="group flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium {{ request()->routeIs('school-settings.*') ? 'bg-teal-600 text-white' : 'text-gray-700 hover:bg-gray-50' }}">
