...
@endphp
<aside x-data="{ collapsed: JSON.parse(localStorage.getItem('sidebarCollapsed') || 'false') }" x-init="$watch('collapsed', v => localStorage.setItem('sidebarCollapsed', JSON.stringify(v)))" :class="collapsed ? 'w-20' : 'w-64'" class="hidden sm:flex sm:flex-col bg-white shadow-lg border-r border-gray-100 overflow-hidden transition-all duration-300 ease-in-out">
    <!-- SIMMAS Header -->
    ...
    <nav class="flex-1 px-4">
        ...
        <ul class="space-y-2">
            <li>
                <a href="{{ route('dashboard') }}" title="Dashboard" class="group flex items-center rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('dashboard') ? 'bg-teal-600 text-white' : 'text-gray-700 hover:bg-gray-50' }}" :class="collapsed ? 'justify-center p-3' : 'gap-3 px-4 py-3'">
            ...
            <li>
                <a href="{{ route('dudis.index') }}" title="DUDI" class="group flex items-center rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('dudis.*') ? 'bg-teal-600 text-white' : 'text-gray-700 hover:bg-gray-50' }}" :class="collapsed ? 'justify-center p-3' : 'gap-3 px-4 py-3'">
            ...
            <li>
                <a href="{{ route('internships.index') }}" title="Magang" class="group flex items-center rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('internships.*') ? 'bg-teal-600 text-white' : 'text-gray-700 hover:bg-gray-50' }}" :class="collapsed ? 'justify-center p-3' : 'gap-3 px-4 py-3'">
            ...
            @if($role === 'guru')
            <li>
                <a href="{{ route('journals.index') }}" title="Jurnal Harian" class="group flex items-center rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('journals.*') ? 'bg-teal-600 text-white' : 'text-gray-700 hover:bg-gray-50' }}" :class="collapsed ? 'justify-center p-3' : 'gap-3 px-4 py-3'">
            ...
            @if($role === 'admin')
            <li>
                <a href="{{ route('users.index') }}" title="Pengguna" class="group flex items-center rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('users.*') ? 'bg-teal-600 text-white' : 'text-gray-700 hover:bg-gray-50' }}" :class="collapsed ? 'justify-center p-3' : 'gap-3 px-4 py-3'">
            ...
            <li>
                <a href="{{ route('school-settings.index') }}" title="Pengaturan" class="group flex items-center rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('school-settings.*') ? 'bg-teal-600 text-white' : 'text-gray-700 hover:bg-gray-50' }}" :class="collapsed ? 'justify-center p-3' : 'gap-3 px-4 py-3'">
